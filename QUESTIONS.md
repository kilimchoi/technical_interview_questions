...
- Given a 3*3 matrix with the numbers 1-8 in random order and a space in the middle spot: 
        Write code to find the min exchange of numbers to put the matrix in order
            
            5 4 1           1 2 3
            3   2   --->    8   4
            7 8 6           7 6 5
- For k parenthesis, write code to calculate how many permutations they could have 
    For 2 parenthesis, there are 2 permutations: ()() and (())
